...
namespace ca { namespace gui {
	...
	public:
		...
		virtual uint getTextCharacterPosition(const ei::Vec2& _findPosition, const ei::Vec2& _textPosition, const char* _text, float _size, float _alignX = 0.0f, float _alignY = 0.0f, float _rotation = 0.0f, bool _roundToPixel = false) override;
		virtual void drawRect(const ei::Rect2D& _rect, const ei::Vec4& _color) override;
		virtual void drawRect(const ei::Rect2D& _rect, const ei::Vec2& _a, const ei::Vec2& _b, const ei::Vec4& _colorA, const ei::Vec4& _colorB, GradientMode _mode = GradientMode::LINEAR) override;
		virtual void drawTextureRect(const ei::Rect2D& _rect, uint64 _texture, float _opacity, bool _tiling) override;
